...
class IntelI5 : public Processor{
    ...
    void GetConfiguration(){
        cout << "1.50 Ghz, up to 2.0 Ghz with turbo, 2 cores, 4 threads, 8 MB cache, RAM 4 GB - 8GB" << endl;
    }
};
...
class IntelI7 : public Processor{
    ...
    void GetConfiguration(){
        cout << "1.60 Ghz, up to 1.9 Ghz, 9na Gen, 4 cores, 8 threads, 16 MB cache, RAM 16" << endl;
    }
};
...
class NormalDisplay : public Drive{
    string GetName(){
...
class LaptopBuilder{
    public:
        Laptop *opcion1(){
            ...
            lap->AddParts(new NormalDisplay());
